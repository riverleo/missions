...
- 플랜 구현 시작 전 아래 절차를 반드시 선행한다.
  ...
  2.  플랜 전용 브랜치 생성
  3.  원격 푸시 및 PR 생성
- PR 제목/본문 규칙은 `docs/agents/planner/AGENTS.md`를 단일 출처로 따른다.
- Linear 상태 기반 자동화 상세 규칙은 `docs/agents/planner/AGENTS.md`를 단일 출처로 따른다.
- Linear `Done` 상태 전환 시 PR 머지 규칙은 `docs/agents/planner/AGENTS.md`를 따른다.
