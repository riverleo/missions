		...
		Tables: {
			...
			building_interactions: {
				Row: {
					...
					created_at: string;
					created_by: string | null;
					fulfill_interaction_type: Database['public']['Enums']['fulfill_interaction_type'] | null;
					id: string;
					once_interaction_type: Database['public']['Enums']['once_interaction_type'] | null;
					scenario_id: string;
					system_interaction_type: Database['public']['Enums']['system_interaction_type'] | null;
