...
export type Database = {
	...
	public: {
		Tables: {
			...
			building_interactions: {
				Row: {
					...
					created_by: string | null;
					id: string;
					once_interaction_type: Database['public']['Enums']['once_interaction_type'] | null;
					repeat_interaction_type: Database['public']['Enums']['repeat_interaction_type'] | null;
					scenario_id: string;
				};
				Insert: {
					building_id?: string | null;
			...
			character_body_states: {
				Row: {
					atlas_name: string;
					body_id: string;
					character_face_state: Database['public']['Enums']['character_face_state_type'] | null;
					fps: number | null;
					frame_from: number | null;
					frame_to: number | null;
					id: string;
			...
			need_fulfillments: {
				Row: {
					...
					need_id: string;
					scenario_id: string;
					task_condition: Database['public']['Enums']['need_fulfillment_task_condition'] | null;
					task_count: number;
		...
		Enums: {
			...
			repeat_interaction_type: 'building_repair' | 'building_clean' | 'character_hug';
