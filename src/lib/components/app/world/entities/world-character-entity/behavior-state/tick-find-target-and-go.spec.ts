...
describe('tickFindTargetAndGo(this: WorldCharacterEntityBehavior)', () => {
	...
	it('현재 행동 타깃이 없으면 계속 진행한다', () => {
		...
		const result = behavior.tickFindTargetAndGo();
