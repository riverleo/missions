...
export type TickActionOnceBuildingConstructFixture = {
	entity: WorldCharacterEntity;
	matchingTargetId: InteractionTargetId;
	nonMatchingTargetId: InteractionTargetId;
};

export default function (): TickActionOnceBuildingConstructFixture {
	...
	const matchingInteraction = createItemInteraction(item, {
		type: 'once',
		once_interaction_type: 'building_construct',
	});
