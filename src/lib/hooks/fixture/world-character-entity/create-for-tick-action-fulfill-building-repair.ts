...
export type TickActionFulfillBuildingRepairFixture = {
	entity: WorldCharacterEntity;
	matchingTargetId: InteractionTargetId;
	nonMatchingTargetId: InteractionTargetId;
};

export default function (): TickActionFulfillBuildingRepairFixture {
	...
	const matchingInteraction = createItemInteraction(item, {
		type: 'fulfill',
		fulfill_interaction_type: 'building_repair',
	});
