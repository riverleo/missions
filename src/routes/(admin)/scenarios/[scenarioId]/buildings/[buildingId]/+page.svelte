<script lang="ts">
	...
	import BuildingPanel from '$lib/components/building/building-action-panel.svelte';
	import BuildingStateItemGroup from '$lib/components/building/building-state-item-group.svelte';
