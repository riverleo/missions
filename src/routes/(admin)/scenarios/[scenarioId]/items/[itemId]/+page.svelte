<script lang="ts">
	...
	import ItemStateItemGroup from '$lib/components/item/item-state-item-group.svelte';
	import ItemActionPanel from '$lib/components/item/item-action-panel.svelte';
