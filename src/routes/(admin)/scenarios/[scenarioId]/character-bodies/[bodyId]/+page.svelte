<script lang="ts">
	...
	import CharacterBodyPanel from '$lib/components/character-body/character-body-action-panel.svelte';
	import CharacterBodyStateItemGroup from '$lib/components/character-body/character-body-state-item-group.svelte';
