<script lang="ts">
	...
	import TerrainActionPanel from '$lib/components/terrain/terrain-action-panel.svelte';
	import TerrainPreview from '$lib/components/terrain/terrain-preview.svelte';
