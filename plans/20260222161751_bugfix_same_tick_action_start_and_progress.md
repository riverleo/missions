...
## 담당자
진행: 플래너가 범위/완료 기준을 고정하고 역할 호출 후, 구현 역할(게임 디자이너/플랫폼 엔지니어/테스트 엔지니어)이 순차 진행한다.
- 플래너
- 게임 디자이너
- 플랫폼 엔지니어
- 테스트 엔지니어
...
```text
[게임 디자이너]
20260222161751_bugfix_same_tick_action_start_and_progress 진행

[게임 디자이너, 테스트 엔지니어]
20260222161751_bugfix_same_tick_action_start_and_progress 플랜 구현 시작
```
